...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel1->Controls->Add(this->btnEnterGrades);
			...
			this->btnInfo->Click += gcnew System::EventHandler(this, &facultyDashboard::button6_Click);
			// 
			// btnSettings
			// 
			...
			this->btnSettings->Click += gcnew System::EventHandler(this, &facultyDashboard::button5_Click);
			// 
			// btnViewSchedule
			// 
			...
			this->btnViewSchedule->Click += gcnew System::EventHandler(this, &facultyDashboard::button4_Click);
			// 
			// btnGenerateReport
			// 
			...
			this->btnGenerateReport->Font = (gcnew System::Drawing::Font(L"Century Gothic", 8, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btnGenerateReport->ForeColor = System::Drawing::Color::White;
			this->btnGenerateReport->ImageAlign = System::Drawing::ContentAlignment::MiddleLeft;
			this->btnGenerateReport->Location = System::Drawing::Point(15, 197);
			this->btnGenerateReport->Name = L"btnGenerateReport";
			this->btnGenerateReport->Size = System::Drawing::Size(201, 49);
			...
			this->btnGenerateReport->Click += gcnew System::EventHandler(this, &facultyDashboard::button3_Click);
			// 
			// btnEnterGrades
			// 
			...
			this->btnEnterGrades->Font = (gcnew System::Drawing::Font(L"Century Gothic", 8, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btnEnterGrades->ForeColor = System::Drawing::Color::White;
			this->btnEnterGrades->ImageAlign = System::Drawing::ContentAlignment::MiddleLeft;
			this->btnEnterGrades->Location = System::Drawing::Point(15, 148);
			this->btnEnterGrades->Name = L"btnEnterGrades";
			this->btnEnterGrades->Size = System::Drawing::Size(201, 49);
			this->btnEnterGrades->TabIndex = 4;
			this->btnEnterGrades->Text = L"Enter Grades";
			this->btnEnterGrades->TextImageRelation = System::Windows::Forms::TextImageRelation::ImageBeforeText;
			this->btnEnterGrades->UseVisualStyleBackColor = true;
			this->btnEnterGrades->Click += gcnew System::EventHandler(this, &facultyDashboard::button2_Click);
			// 
			// btnDashboard
			// 
			...
			this->btnDashboard->Click += gcnew System::EventHandler(this, &facultyDashboard::button1_Click);
			// 
			// panel4
			// 
			...
			this->panel4->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &facultyDashboard::panel4_Paint);
			// 
			// panel3
			// 
			...
			this->panel3->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &facultyDashboard::panel3_Paint);
			// 
			// panel2
			// 
			...
			this->panel2->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &facultyDashboard::panel2_Paint);
			// 
			// label3
			// 
			...
			this->logoTitle1->Click += gcnew System::EventHandler(this, &facultyDashboard::label1_Click);
			// 
			// Logo
			// 
			...
			this->Logo->Click += gcnew System::EventHandler(this, &facultyDashboard::pictureBox1_Click);
			// 
			// facultyDashboard
			// 
			...
			this->Load += gcnew System::EventHandler(this, &facultyDashboard::Dashboard_Load);
